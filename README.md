...
### 金融行业
- [Numerai, 一家基于人工智能技术的对冲基金公司](https://numer.ai/)
...
- [Zymergen, 合成生物科技初创公司，利用机器学习技术找出微生物内部可能导致所需结果的基因组](https://zymergen.com/)
- [Freenome, 新兴液体活检诊断生物技术公司，通过对血液(自由细胞)中遗传物质流的动态收集，来诊断是否患有癌症](https://www.freenome.com/)
...
- [Lunit, 利用人工智能进行胸部X光异常检测、乳房X光照相术、以及乳腺组织病理切片的自动评级](http://lunit.io/)
- [Enlitic, 一家致力于改进医疗诊断的深度学习公司](http://www.enlitic.com/)
...
- [Fido, 自然语言处理技术公司，专注于利用人工智能技术将决策过程转换为对话](http://fido.ai/)

### 个人助理
- [x.ai, 一款人工智能个人助理，可以为你安排会议](https://x.ai/)
- [Snips, 允许任何人仅用一行代码就能创建自己的人工智能助手](https://snips.ai/)

### 舆情分析
- [Dataminr, 从社交媒体活动中获取信息，建立实时、可执行的消息警告](http://dataminr.com/)
- [Voyager Labs, 分析来自世界数十亿个数据点，了解和预测群体行为，并提出实时可行的建议](http://voyagerlabs.co/)
